...
const Message: FC<PropsWithChildren<Props>> = ({
  ...
  return createPortal(
    <div className="fixed left-1/2 top-4 z-50 flex w-full max-w-72 -translate-x-1/2 items-center gap-2 rounded-md border-2 border-white/5 bg-black px-4 py-2 text-sm">
