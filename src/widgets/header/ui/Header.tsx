...
const Header: FC = () => {
  return (
    <header className="container sticky top-4 z-20 my-2 flex items-center justify-between rounded-full border border-white/5 bg-white/5 p-4 backdrop-blur-lg before:absolute before:left-0 before:-z-10 before:size-full before:rounded-full before:bg-gradient-to-r before:from-yellow/5 before:via-black before:to-lilac/5 sm:gap-8">
